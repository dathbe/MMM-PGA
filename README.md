...
| `showLocation`        | Whether to show the location of the tournament in the tournament details header. If set to true the location will appear under the tournament name in a smaller lighter font. (Also affects Upcoming tournament view.)<br><br>**Type:** `bool` <br> **Default value:** `true`
| `showPurse`           | Whether to show the purse information in the tournament details header. If using a larger font hiding the purse leads to a cleaner format of the tournament details. (Also affects Upcoming tournament view.)<br><br>**Type:** `bool` <br> **Default value:** `true`
...
| **For Rankings**
| `showRankings`        | Whether to show FedEx Cup standings and Official World Go;g Rankings when a tournament is not active. If set to true the module will rotate between the upcoming tournaments, FedEx Cup, and OWGR.<br><br>**Type:** `bool` <br> **Default value:** `true`
